...
hipApp.answers = {
   ...
   userClothing: {
    ...
    userMusic: {
        ...
        radioHead: `Even though you may not identify as a hipster, your attempt at any other identity has failed you. You are not the strongly opinionated type but you know what you are not (or you thought you did) and while your music taste may not be terrible you are possably the closest of the bunch to escaping the hipster label - you've actually fallen here by complete mistake.`,
        ...
        brightEyes: `While you probably had an emo phase (when that was a thing), you've since grown out of it, however, you still have deeper emotions than your average hipster, or anyone for that matter. Heart break and failure hurt you just a little bit more and you're not afraidn to let people know about it on social media. You probably like Elliot Smith (RIP) and talk about the 27 club while pondering existential questions both alone and with your peers.`,
...
hipApp.ageAppropriate = () => {
    ...
    hipApp.bornYear = hipApp.yearFind(userAge);  
    ...
    if (userAge > 50) {
        ...
        const tooOld = `
                <li>
                    ...
                    <p>
                        Being born in ${hipApp.bornYear}, you are unlikely too old to be a hipster...and if you consider yourself one - it might be time to take a look at yourself and ask..."Which were the decisions I made over the course of my life that lead me to be exactly where I am today?" and "Am I happy?". 
                    </p>
                    <p>
        ...
        const tooYoung = `
                <li>
                    <h4>Tough Pills To Swallow, ${userName}</h4>
                    <p>
                        We're sorry you've taken the time to fill out our profiling questions only to be informed that being born in ${hipApp.bornYear} means you are too young to yet be considered for Hipsterdom. You can't even smoke or drink. Now, not all hipsters smoke and/or drink but they are at least old enough to make that choice on there own (The coolest ones dont do either).
                    </p>
                    <p>
